...
const mutations = {
  ...
  // Updates users info in state and localstorage
  UPDATE_USER_INFO(state, payload) {

    // Get Data localStorage
    let userInfo = JSON.parse(localStorage.getItem("userInfo")) || state.AppActiveUser
    //console.log(userInfo.roles.includes.some(v => ["SuperAdmin"].includes(v)))

    for (const property of Object.keys(payload)) {

      if (payload[property] != null) {
        // If some of users property is null - users default property defined in state.AppActiveUser
